...
To make Lemmy available outside the server, you need to setup a reverse proxy, like Nginx. [A sample nginx config](https://github.com/ProjectMakerGeorgia/lemmy-ansible/blob/main/templates/nginx.conf), could be setup with:
